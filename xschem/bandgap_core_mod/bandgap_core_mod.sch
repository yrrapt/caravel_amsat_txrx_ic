...
C {bandgap_resistors_mod/bandgap_resistors_mod.sym} 1270 -220 0 0 {name=xres}
...
C {lab_wire.sym} 2130 -710 0 0 {name=l7 sig_type=std_logic lab=cas}
C {lab_wire.sym} 2340 -710 0 0 {name=l8 sig_type=std_logic lab=cas}
