...
N 870 -810 870 -800 { lab=ptat}
N 1400 -810 1400 -790 { lab=ctat}
N 870 -800 870 -790 { lab=ptat}
...
C {bandgap_cascurr_cell/bandgap_cascurr_cell.sym} 1110 -750 0 0 {name=xcurr_mirror_ctat[2:1] m=1}
...
C {bandgap_cascurr_cell/bandgap_cascurr_cell.sym} 710 -750 0 1 {name=xcurr_ref_ptat[8:1] m=1}
