...
.nodeset v(xdut.q1)=1 v(xdut.q8)=1 v(xdut.ctat_r)
...
C {spice_probe.sym} 600 -330 0 1 {name=p9 analysis=tran voltage=0.529}
C {ammeter.sym} 600 -420 0 0 {name=viout current=5.0264e-06}
...
C {ammeter.sym} 600 -520 0 0 {name=vptat current=2.0489e-06}
C {ammeter.sym} 810 -520 0 0 {name=vctat current=2.9775e-06}
...
C {ammeter.sym} 1020 -420 0 0 {name=viout1 current=5.0302e-06}
...
C {ammeter.sym} 1020 -520 0 0 {name=vptat2 current=2.0498e-06}
C {ammeter.sym} 1230 -520 0 0 {name=vctat3 current=2.9804e-06}
C {code.sym} 120 -430 0 0 {name=STDCELL_MODELS 
only_toplevel=true
place=end
